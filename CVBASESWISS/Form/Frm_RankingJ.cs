...
{
    public partial class Frm_RankingJ : Form
    {
        string c1, c2, c3;
        bool cansave = false;
        public Frm_RankingJ()
        {
            ...
            if(soft.CV_RANKJUN.Count() == 0)
            {
                var newRank = new CV_RANKJUN
                {
                    V1 = 0,
                    V2 = 0,
                    V3 = 0
                };
                soft.CV_RANKJUN.Add(newRank);
                soft.SaveChanges();
            }
            ...
            var isRank = soft.CV_RANKJUN.FirstOrDefault();
        ...
        private void Frm_RankingJ_FormClosing(object sender, FormClosingEventArgs e)
        {
            bool updated = false;
